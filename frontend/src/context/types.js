...
export const SET_SHOW_USER_LIST = 'SET_SHOW_USER_LIST';
export const SHOW_DETAIL_SIDEBAR = 'SHOW_DETAIL_SIDEBAR';
export const SET_TARGET_DETAILS_INFO = 'SET_TARGET_DETAILS_INFO';
export const CHANGE_IMAGE_HASH = 'CHANGE_IMAGE_HASH';
